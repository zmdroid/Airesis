...
a2.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description:'美洲')
...
a3.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '非洲')
...
a4.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '亚洲')
...
s91.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '中国')
...
s220.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '中国台湾省')
...
a5.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '大洋洲')
...
a1.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '欧洲')
...
a6.translations.where(locale: 'zh-CN').first_or_create.update_attributes(description: '南极洲')
